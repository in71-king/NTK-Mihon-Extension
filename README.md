...
Personal Mihon repository containing NTK v1.4.26.
...
Create a public GitHub repository named exactly `NTK-Mihon-Extension`, open a Codespace for it, upload `ntk-mihon-repository-v1.4.26.zip`, then run:

```bash
unzip -o ntk-mihon-repository-v1.4.26.zip
git add apk icon index.json index.min.json README.md
git commit -m "Publish NTK v1.4.26"
git push
```
